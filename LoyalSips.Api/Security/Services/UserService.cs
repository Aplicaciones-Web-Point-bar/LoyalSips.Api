...
using LoyalSips.Api.Security.Domain.Services;
using LoyalSips.Api.Security.Domain.Services.Communication;
using LoyalSips.Api.Security.Exceptions;
using BCryptNet = BCrypt.Net.BCrypt;
using IUserRepository = LoyalSips.Api.Security.Domain.Repositories.IUserRepositoryy;

namespace LoyalSips.API.Security.Services;
